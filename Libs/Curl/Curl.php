...
class Curl
{
    ...
    public static function get($url, $user_agent=null, $proxy=null)
    {
        ...
        $headers = [
            ...
            'Referer: https://www.google.com/search?source=hp&ei=1jauW_6AH4zBgAaA37iwBw&q='.$url_host.'&oq='.$url_host.'&gs_l=psy-ab.3..0i30k1j0i5i10i30k1',
        ...
        if($result === false)
        {
            throw new Exception("Curl error {$curl_errno}:".self::getCurlErrNoExplain($curl_errno));
        }
        else
        {
